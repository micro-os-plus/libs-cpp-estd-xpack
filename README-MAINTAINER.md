...
- name the file like `2020-12-19-libs-cpp-estd-v0-1-0-released.md`
- name the post like: **µOS++ libs-cpp-estd v0.1.0 released**
...
- `npm dist-tag add @micro-os-plus/libs-cpp-estd@0.1.0 latest`
- `npm dist-tag ls @@micro-os-plus/libs-cpp-estd`
...
- paste the release name like **µOS++ libs-cpp-estd v0.1.0 released**
