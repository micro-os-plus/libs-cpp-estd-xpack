...
- name the post like: **µOS++ libs-cpp-estd v2.0.2 released**
...
- `npm dist-tag add @micro-os-plus/libs-cpp-estd@2.0.2 latest`
- `npm dist-tag ls @@micro-os-plus/libs-cpp-estd`
...
- paste the release name like **µOS++ libs-cpp-estd v2.0.2 released**
